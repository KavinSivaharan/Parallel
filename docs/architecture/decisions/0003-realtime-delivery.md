...
Commit events and an outbox record in PostgreSQL, then publish through Redis to connected gateways. Clients track the last durable stream sequence and recover gaps from the HTTP catch-up endpoint. Presence and typing-like signals may remain ephemeral.
